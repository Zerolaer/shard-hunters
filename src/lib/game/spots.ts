...
const SPOT_NAMES: Record<string, string[][]> = {
  ...
  "crown-scar": g(
    ["Край шрама", "Треснувший венец", "Пыль короны", "Первый удар"],
    ["Обломок венца", "Стража трещины", "Пепельный двор", "Клинок шрама"],
    ["Глубина шва", "Немой венец", "Сердце трещины", "Первый Шрам"],
  ),
  "null-cathedral": g(
    ["Паперть нуля", "Безмолвный неф", "Хор без рта", "Свеча без огня"],
    ["Клирик пустоты", "Столп веса", "Исповедальня", "Алтарь без бога"],
    ["Крипта нуля", "Купол без неба", "Трон проповедника", "Архитектор Нуля"],
  ),
  "eternal-wound": g(
    ["Край раны", "Кровавый шов", "Незаживший двор", "Эхо удара"],
    ["Страж раны", "Живая щель", "Плоть мира", "Клинок шва"],
    ["Глубина боли", "Нет шва", "Сердце удара", "Сердце Раны"],
  ),
  "ash-of-thrones": g(
    ["Пепельный двор", "Могила корон", "Прах герольдов", "Без имени"],
    ["Тронный прах", "Корона без лица", "Последний вес", "Пепельный соверен"],
    ["Урна престолов", "Немой венец", "Конец корон", "Пепельный Престол"],
  ),
};
